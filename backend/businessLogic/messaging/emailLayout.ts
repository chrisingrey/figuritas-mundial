...
export function buildBrandedEmail(args: BrandedEmailArgs): string {
  ...
  const actionHtml = args.action
    ? `<table cellpadding="0" cellspacing="0" role="presentation" style="margin:26px 0 20px;">
        <tr>
          <td style="background:#2368c4;border:2px solid #101214;border-radius:8px;box-shadow:5px 5px 0 #101214;">
          ...
          ${args.stats.map((stat) => `
            <td width="${Math.floor(100 / args.stats!.length)}%" style="padding:0 4px 8px 0;">
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td style="background:#b9e461;border:2px solid #101214;border-radius:8px;padding:12px;text-align:center;">
  ...
  const codeHtml = args.code
    ? `<table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin:22px 0;">
        <tr>
          <td style="background:#f7d719;border:2px solid #101214;border-radius:8px;padding:18px;text-align:center;">
...
<body style="margin:0;padding:0;background:#f8f7f1;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;-webkit-font-smoothing:antialiased;">
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background:#f8f7f1;padding:20px 12px;">
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:520px;background:#ffffff;border:2px solid #101214;border-radius:8px;box-shadow:8px 8px 0 rgba(16,18,20,0.18);overflow:hidden;">
          <tr>
            <td style="padding:0;background:#ffffff;border-bottom:2px solid #101214;">
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td style="width:22px;background:#29b7b8;"></td>
                  <td style="padding:22px 18px;">
                    <div style="font-size:11px;color:#101214;font-weight:900;text-transform:uppercase;">${eyebrow}</div>
                    <div style="font-size:34px;line-height:0.9;color:#101214;font-weight:900;text-transform:uppercase;margin-top:6px;">Figuritas</div>
                    <div style="font-size:20px;line-height:1;color:#101214;font-weight:900;text-transform:uppercase;">Mundial 2026</div>
                  </td>
                  <td style="width:22px;background:#ff6d00;"></td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td style="padding:28px 20px 24px;">
              <p style="margin:0 0 12px;color:#101214;font-size:24px;line-height:1.05;font-weight:900;">${title}</p>
          ...
          <tr>
            <td style="padding:16px 20px;background:#101214;">
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
